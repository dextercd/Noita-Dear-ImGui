...
// Same as the default ImGui SDL backend but with some fixes. Specifically, it
// fixes an issue where the mouse position isn't updated as frequently when you
...
static bool ImGui_ImplSDL2_Init(SDL_Window* window, SDL_Renderer* renderer, void* sdl_gl_context)
{
    ...
    if (SDL_HAS_CAPTURE_AND_GLOBAL_MOUSE && !running_on_wine()) {
...
static void ImGui_ImplSDL2_UpdateMouseData()
{
    ...
    if (!running_on_wine()) {
        ...
        is_app_focused = (focused_window && (bd->Window == focused_window || ImGui::FindViewportByPlatformHandle((void*)focused_window)));
    } else {
