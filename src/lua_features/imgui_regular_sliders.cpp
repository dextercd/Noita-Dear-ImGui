...
void add_imgui_regular_sliders(sol::table& imgui)
{
    ...
    imgui.set_function("SliderFloat2",
        sol::overload(
            [](const char* label, float v1, float v2, float v_min, float v_max) { float v[2]{v1, v2}; auto ret = ImGui::SliderFloat2(label, v, v_min, v_max); return std::tuple{ret, v[0], v[1]}; },
    ...
    imgui.set_function("SliderFloat3",
        sol::overload(
            [](const char* label, float v1, float v2, float v3, float v_min, float v_max) { float v[3]{v1, v2, v3}; auto ret = ImGui::SliderFloat3(label, v, v_min, v_max); return std::tuple{ret, v[0], v[1], v[2]}; },
    ...
    imgui.set_function("SliderFloat4",
        sol::overload(
            [](const char* label, float v1, float v2, float v3, float v4, float v_min, float v_max) { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::SliderFloat4(label, v, v_min, v_max); return std::tuple{ret, v[0], v[1], v[2], v[3]}; },
