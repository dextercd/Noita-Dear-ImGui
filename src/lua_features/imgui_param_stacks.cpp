...
void add_imgui_param_stacks(sol::table& imgui)
{
    ...
    imgui.set_function("PushItemFlag", sol::resolve<void(ImGuiItemFlags, bool)>(ImGui::PushItemFlag));
    imgui.set_function("PopItemFlag", sol::resolve<void()>(ImGui::PopItemFlag));
