...
void add_keyboard_input(sol::table& imgui)
{
    ...
    imgui.set_function("InputText",
        sol::overload(
            ...
            [](const char* label, std::string str, ImGuiInputTextFlags flags) { auto ret = ImGui_InputText(label, &str, flags); return std::tuple{ret, str}; }
        ));
    ...
    imgui.set_function("InputTextMultiline",
        sol::overload(
            ...
            [](const char* label, std::string str, float size_x, float size_y, ImGuiInputTextFlags flags) { auto ret = ImGui_InputTextMultiline(label, &str, {size_x, size_y}, flags); return std::tuple{ret, str}; }
        ));
    ...
    imgui.set_function("InputTextWithHint",
        sol::overload(
            ...
            [](const char* label, const char* hint, std::string str, ImGuiInputTextFlags flags) { auto ret = ImGui_InputTextWithHint(label, hint, &str, flags); return std::tuple{ret, str}; }
        ));
    ...
    imgui.set_function("InputFloat",
        sol::overload(
            ...
            [](const char* label, float v, float step, float step_fast, const char* format, ImGuiInputTextFlags flags) { auto ret = ImGui::InputFloat(label, &v, step, step_fast, format, flags); return std::tuple{ret, v}; }));
    ...
    imgui.set_function("InputFloat2",
        sol::overload(
            ...
            [](const char* label, float v1, float v2, const char* format, ImGuiInputTextFlags flags) { float v[2]{v1, v2}; auto ret = ImGui::InputFloat2(label, v, format, flags); return std::tuple{ret, v[0], v[1]}; }));
    ...
    imgui.set_function("InputFloat3",
        sol::overload(
            ...
            [](const char* label, float v1, float v2, float v3, const char* format, ImGuiInputTextFlags flags) { float v[3]{v1, v2, v3}; auto ret = ImGui::InputFloat3(label, v, format, flags); return std::tuple{ret, v[0], v[1], v[2]}; }));
    ...
    imgui.set_function("InputFloat4",
        sol::overload(
            ...
            [](const char* label, float v1, float v2, float v3, float v4, const char* format, ImGuiInputTextFlags flags) { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::InputFloat4(label, v, format, flags); return std::tuple{ret, v[0], v[1], v[2], v[3]}; }));
    ...
    imgui.set_function("InputInt",
        sol::overload(
            ...
            [](const char* label, int v, int step, int step_fast, ImGuiInputTextFlags flags) { auto ret = ImGui::InputInt(label, &v, step, step_fast, flags); return std::tuple{ret, v}; }));
    ...
    imgui.set_function("InputInt2",
        sol::overload(
            ...
            [](const char* label, int v1, int v2, ImGuiInputTextFlags flags) { int v[2]{v1, v2}; auto ret = ImGui::InputInt2(label, v, flags); return std::tuple{ret, v[0], v[1]}; }));
    ...
    imgui.set_function("InputInt3",
        sol::overload(
            ...
            [](const char* label, int v1, int v2, int v3, ImGuiInputTextFlags flags) { int v[3]{v1, v2, v3}; auto ret = ImGui::InputInt3(label, v, flags); return std::tuple{ret, v[0], v[1], v[2]}; }));
    ...
    imgui.set_function("InputInt4",
        sol::overload(
            ...
            [](const char* label, int v1, int v2, int v3, int v4, ImGuiInputTextFlags flags) { int v[4]{v1, v2, v3, v4}; auto ret = ImGui::InputInt4(label, v, flags); return std::tuple{ret, v[0], v[1], v[2], v[3]}; }));
    ...
    imgui.set_function("InputDouble",
        sol::overload(
            ...
            [](const char* label, double v, double step, double step_fast, const char* format, ImGuiInputTextFlags flags) { auto ret = ImGui::InputDouble(label, &v, step, step_fast, format, flags); return std::tuple{ret, v}; }));
}
