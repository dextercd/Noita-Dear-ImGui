...
void add_imgui_color_editor(sol::table& imgui)
{
    ...
    imgui.set_function("ColorEdit3",
        sol::overload(
            [](const char* label, float r, float g, float b) { float col[3]{r, g, b}; auto ret = ImGui::ColorEdit3(label, col); return std::tuple{ret, col[0], col[1], col[2]}; },
    ...
    imgui.set_function("ColorEdit4",
        sol::overload(
            [](const char* label, float r, float g, float b, float a) { float col[4]{r, g, b, a}; auto ret = ImGui::ColorEdit4(label, col); return std::tuple{ret, col[0], col[1], col[2], col[3]}; },
    ...
    imgui.set_function("ColorPicker3",
        sol::overload(
            [](const char* label, float r, float g, float b) { float col[3]{r, g, b}; auto ret = ImGui::ColorPicker3(label, col); return std::tuple{ret, col[0], col[1], col[2]}; },
    ...
    imgui.set_function("ColorPicker4",
        sol::overload(
            [](const char* label, float r, float g, float b, float a) { float col[4]{r, g, b, a}; auto ret = ImGui::ColorPicker4(label, col); return std::tuple{ret, col[0], col[1], col[2], col[3]}; },
    ...
    imgui.set_function("ColorButton",
        sol::overload(
            [](const char* desc_id, float r, float g, float b, float a) { return ImGui::ColorButton(desc_id, {r, g, b, a}); },
