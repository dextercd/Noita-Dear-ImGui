...
void add_imgui_drag_sliders(sol::table& imgui)
{
    ...
    imgui.set_function("DragFloat",
        sol::overload(
            [](const char* label, float v) -> std::tuple<bool, float> { auto ret = ImGui::DragFloat(label, &v); return std::tuple{ret, v}; },
    ...
    imgui.set_function("DragFloat2",
        sol::overload(
            [](const char* label, float v1, float v2) -> std::tuple<bool, float, float> { float v[2]{v1, v2}; auto ret = ImGui::DragFloat2(label, v); return std::tuple{ret, v[0], v[1]}; },
            [](const char* label, float v1, float v2, float v_speed) { float v[2]{v1, v2}; auto ret = ImGui::DragFloat2(label, v, v_speed); return std::tuple{ret, v[0], v[1]}; },
            [](const char* label, float v1, float v2, float v_speed, float v_min) { float v[2]{v1, v2}; auto ret = ImGui::DragFloat2(label, v, v_speed, v_min); return std::tuple{ret, v[0], v[1]}; },
            [](const char* label, float v1, float v2, float v_speed, float v_min, float v_max) { float v[2]{v1, v2}; auto ret = ImGui::DragFloat2(label, v, v_speed, v_min, v_max); return std::tuple{ret, v[0], v[1]}; },
            [](const char* label, float v1, float v2, float v_speed, float v_min, float v_max, const char* format) { float v[2]{v1, v2}; auto ret = ImGui::DragFloat2(label, v, v_speed, v_min, v_max, format); return std::tuple{ret, v[0], v[1]}; },
            [](const char* label, float v1, float v2, float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) { float v[2]{v1, v2}; auto ret = ImGui::DragFloat2(label, v, v_speed, v_min, v_max, format, flags); return std::tuple{ret, v[0], v[1]}; }));

    imgui.set_function("DragFloat3",
        sol::overload(
            [](const char* label, float v1, float v2, float v3) -> std::tuple<bool, float, float, float> { float v[3]{v1, v2, v3}; auto ret = ImGui::DragFloat3(label, v); return std::tuple{ret, v[0], v[1], v[2]}; },
            [](const char* label, float v1, float v2, float v3, float v_speed) { float v[3]{v1, v2, v3}; auto ret = ImGui::DragFloat3(label, v, v_speed); return std::tuple{ret, v[0], v[1], v[2]}; },
            [](const char* label, float v1, float v2, float v3, float v_speed, float v_min) { float v[3]{v1, v2, v3}; auto ret = ImGui::DragFloat3(label, v, v_speed, v_min); return std::tuple{ret, v[0], v[1], v[2]}; },
            [](const char* label, float v1, float v2, float v3, float v_speed, float v_min, float v_max) { float v[3]{v1, v2, v3}; auto ret = ImGui::DragFloat3(label, v, v_speed, v_min, v_max); return std::tuple{ret, v[0], v[1], v[2]}; },
            [](const char* label, float v1, float v2, float v3, float v_speed, float v_min, float v_max, const char* format) { float v[3]{v1, v2, v3}; auto ret = ImGui::DragFloat3(label, v, v_speed, v_min, v_max, format); return std::tuple{ret, v[0], v[1], v[2]}; },
            [](const char* label, float v1, float v2, float v3, float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) { float v[3]{v1, v2, v3}; auto ret = ImGui::DragFloat3(label, v, v_speed, v_min, v_max, format, flags); return std::tuple{ret, v[0], v[1], v[2]}; }));

    imgui.set_function("DragFloat4",
        sol::overload(
            [](const char* label, float v1, float v2, float v3, float v4) -> std::tuple<bool, float, float, float, float> { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::DragFloat4(label, v); return std::tuple{ret, v[0], v[1], v[2], v[3]}; },
            [](const char* label, float v1, float v2, float v3, float v4, float v_speed) { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::DragFloat4(label, v, v_speed); return std::tuple{ret, v[0], v[1], v[2], v[3]}; },
            [](const char* label, float v1, float v2, float v3, float v4, float v_speed, float v_min) { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::DragFloat4(label, v, v_speed, v_min); return std::tuple{ret, v[0], v[1], v[2], v[3]}; },
            [](const char* label, float v1, float v2, float v3, float v4, float v_speed, float v_min, float v_max) { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::DragFloat4(label, v, v_speed, v_min, v_max); return std::tuple{ret, v[0], v[1], v[2], v[3]}; },
            [](const char* label, float v1, float v2, float v3, float v4, float v_speed, float v_min, float v_max, const char* format) { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::DragFloat4(label, v, v_speed, v_min, v_max, format); return std::tuple{ret, v[0], v[1], v[2], v[3]}; },
            [](const char* label, float v1, float v2, float v3, float v4, float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::DragFloat4(label, v, v_speed, v_min, v_max, format, flags); return std::tuple{ret, v[0], v[1], v[2], v[3]}; }));

    imgui.set_function("DragFloatRange2",
        sol::overload(
            [](const char* label, float v_current_min, float v_current_max) -> std::tuple<bool, float, float> { auto ret = ImGui::DragFloatRange2(label, &v_current_min, &v_current_max); return std::tuple{ret, v_current_min, v_current_max}; },
    ...
    imgui.set_function("DragInt",
        sol::overload(
            [](const char* label, int v) -> std::tuple<bool, int> { auto ret = ImGui::DragInt(label, &v); return std::tuple{ret, v}; },
    ...
    imgui.set_function("DragInt2",
        sol::overload(
            [](const char* label, int v1, int v2) -> std::tuple<bool, int, int> { int v[2]{v1, v2}; auto ret = ImGui::DragInt2(label, v); return std::tuple{ret, v[0], v[1]}; },
    ...
    imgui.set_function("DragInt3",
        sol::overload(
            [](const char* label, int v1, int v2, int v3) -> std::tuple<bool, int, int, int> { int v[3]{v1, v2, v3}; auto ret = ImGui::DragInt3(label, v); return std::tuple{ret, v[0], v[1], v[2]}; },
    ...
    imgui.set_function("DragInt4",
        sol::overload(
            [](const char* label, int v1, int v2, int v3, int v4) -> std::tuple<bool, int, int, int, int> { int v[4]{v1, v2, v3, v4}; auto ret = ImGui::DragInt4(label, v); return std::tuple{ret, v[0], v[1], v[2], v[3]}; },
    ...
    imgui.set_function("DragIntRange2",
        sol::overload(
            [](const char* label, int v_current_min, int v_current_max) -> std::tuple<bool, int, int> { auto ret = ImGui::DragIntRange2(label, &v_current_min, &v_current_max); return std::tuple{ret, v_current_min, v_current_max}; },
