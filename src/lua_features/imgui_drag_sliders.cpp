...
void add_imgui_drag_sliders(sol::table& imgui)
{
    ...
    imgui.set_function("DragFloat2",
        sol::overload(
            [](const char* label, float v1, float v2) { float v[2]{v1, v2}; auto ret = ImGui::DragFloat2(label, v); return std::tuple{ret, v[0], v[1]}; },
    ...
    imgui.set_function("DragFloat3",
        sol::overload(
            [](const char* label, float v1, float v2, float v3) { float v[3]{v1, v2, v3}; auto ret = ImGui::DragFloat3(label, v); return std::tuple{ret, v[0], v[1], v[2]}; },
    ...
    imgui.set_function("DragFloat4",
        sol::overload(
            [](const char* label, float v1, float v2, float v3, float v4) { float v[4]{v1, v2, v3, v4}; auto ret = ImGui::DragFloat4(label, v); return std::tuple{ret, v[0], v[1], v[2], v[3]}; },
